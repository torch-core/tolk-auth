...
export const Topics = {
    PUBLIC_CAPABILITY_UPDATED: 0xd213468c,
    ROLE_CAPABILITY_UPDATED: 0x6aa264fa,
    USER_ROLE_UPDATED: 0x31322498,
    OWNERSHIP_PROPOSED: 0x261921b7,
    OWNERSHIP_CLAIMED: 0x5aab7991,
    OWNERSHIP_REVOKED: 0x4f2bd7df,
};
